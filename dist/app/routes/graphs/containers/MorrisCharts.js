...
{/* 
                        ...
                        >
                            ...
                            <JarvisWidget editbutton={false}>
                                ...
                                <div>
                                    <div className="widget-body no-padding">
                                        <MorrisGraph data={this.props.listgraph}
                                                     type="bar"
                                                     xkey={'month'}
                                                     ykeys={ ['jlmapllicant', 'jlmapllicantpending', 'jlmapllicantapprove']}
                                                     labels={ [LanguageStore.translate('Applicants'), LanguageStore.translate('Pending'), LanguageStore.translate('Approved')]}
                                                     stacked={ true}
                                                     />
                                    </div>
                                </div>
    ...
    _barColorsDemo (row, series, type) {
      //, LanguageStore.translate('Approved')
      //   if (type === 'bar') {
      //       if (row.label == LanguageStore.translate('Applicants')) return "#36A2EB"
      //       else if (row.label == LanguageStore.translate('Pending')) return "#FF6384";
      //       else if (row.label == LanguageStore.translate('Approved')) return "#FFCE56";
      //   }else {
      //           return '#000';
      //       }
        if (type === 'bar') {
