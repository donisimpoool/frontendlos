...
import HondaMod from '../../../../../components/forms/commons/HondaMod';

export default class Honda extends React.Component{ 
                    ...
                    <div className="col-sm-6">
                        <div className="form-group">
                            ...
                            <input className="col-xs-4 col-md-12 input-lg" required 
                                        autoComplete="off"
                                        placeholder="Select a The Model..." type="text" name="honda" list="HondaMod"/>
                                        <datalist id="HondaMod">
                                        {HondaMod.map(function(HondaMod){
                                        return <option value={HondaMod.key} key={HondaMod.key}>{HondaMod.value}</option>
                                    })}
                              </datalist>
                            </div>
                        </div>
