...
export default class ChartJs extends React.Component {
  ...
  render() {
      ...
      var doughnutchart = {
              labels:[LanguageStore.translate('Applicants'),LanguageStore.translate('Approved'),LanguageStore.translate('Pending') ],
              datasets:[
                  {
                      data:[this.props.datagraphdonuts.jmlapplied,this.props.datagraphdonuts.jmlapprove,this.props.datagraphdonuts.jmlpending],
                      backgroundColor:["#36A2EB","#6bc517","#e42b0e"],
                      hoverBackgroundColor:["#36A2EB","#6bc517","#e42b0e"]
                  }
                  ]

      }
      var jsondoughnutchart = JSON.parse(JSON.stringify(doughnutchart));
    return (
      <div id="content">
        {/* <div className="row">
        ...
        {/* <WidgetGrid> */}
          <div className="row">
            ...
            <JarvisWidget editbutton={false}>
                ...
                <div>
                  <div className="widget-body">
                    <ChartJsGraph type="doughnut" data={jsondoughnutchart}/>
                  </div>
                </div>
              </JarvisWidget>
