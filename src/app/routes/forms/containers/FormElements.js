...
export default class FormElements extends React.Component {
  render() {
    return (
      <div id="content">
        <div className="row">
          <BigBreadcrumbs items={['Forms', 'Form Elements']} icon="fa fa-fw fa-pencil-square-o"
        ...
        <div className="row">
          <div className="col-sm-12">
            ...
            <div className="well">
              ...
              <p>
                You can explore some of the <a href="#/forms/layouts"
                                               title="Go to Bootstrap Forms">layouts</a> made using Smart Forms
                grid system or if you are not comfortable with this grid system you can
                simply stick to the default <a href="#/forms/bootstrap-form-elements"
                    ...
                    <form className="smart-form">
                      ...
                      <fieldset>
                        ...
                        <section>
                          ...
                          <span className="button"><input type="file"
                           id="file" name="file"
                                  />Browse</span><input
