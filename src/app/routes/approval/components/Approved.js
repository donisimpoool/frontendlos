...
import {keyset, suburlSendLoan, suburlupdatestatus} from "../../../config/baseUrl";
...
function showLoad(){
    // var ring = React.createElement("div",
    //     { className: "lds-ring" },
    //     "Hello from React."
    // );
                ...
                {/*<WidgetGrid>*/}
                    ...
                    <div className="row">
                        <article className="col-xs-14 col-sm-14 col-md-14 col-lg-14">
                            ...
                            <JarvisWidget className="well" editbutton={false} fullscreenbutton={false} deletebutton={false} color="green">
                                ...
                                <div>
                                    <div className="widget-body no-padding">
                                        ...
                                        <BootstrapTable data={ this.props.listallitemsapproved } pagination={true} striped={true} hover={true} condensed= {true} search={true}
